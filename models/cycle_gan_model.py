...
class CycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--init_weights', type=str, default='kaiming', help='init')
            parser.add_argument('--init_weights_seg', type=str, default=None, help='directory to the pth model')
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            ...
            self.netD_B = networks.define_D(opt.input_nc, opt.ndf, opt.netD,
                                            opt.n_layers_D, opt.norm, opt.init_type, opt.init_gain, self.gpu_ids)
            self.semantic = networks.semantic(init_weights=opt.init_weights_seg, gpu_ids=self.gpu_ids)
